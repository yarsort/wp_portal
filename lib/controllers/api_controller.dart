...
Future<String> getBaseUrl() async {
  ...
  switch(nameServer) {
    ...
    case 'portal.rsvmoto.com.ua':
      return 'http://api-tehno.yarsoft.com.ua:35944/moto/hs/portal';
...
Future<String> getBasePhotoUrl() async {
  ...
  switch(nameServer) {
    ...
    case 'portal.rsvmoto.com.ua':
      return 'http://portal.rsvmoto.com.ua/images';
...
Future<List<Contact>> getCompanyPhones() async {
  ...
  switch(nameServer) {
    ...
    case 'portal.rsvmoto.com.ua':
      ...
      Contact contact2 = Contact();
      contact2.phone = '+38(067)128-22-88';
      contact2.name = '';

      Contact contact3 = Contact();
      contact3.phone = 'Україна, Вінниця, Келецька 50Б';
      contact3.name = '';
    ...
    default:
      Contact contact1 = Contact();
      contact1.phone = '+38(098)854-78-70';
      contact1.name = 'Ярослав';

      Contact contact2 = Contact();
      contact2.phone = 'Україна, Вінниця, Келецька 50Б';
      contact2.name = '';
